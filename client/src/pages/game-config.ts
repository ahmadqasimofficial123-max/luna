...
const HUB_GAME_ENTRIES: HubGame[] = [
  ...
  { slug: "drift-boss", title: "Drift Boss", eyebrow: "POKI ARCADE", genre: "Racing", category: "Poki", description: "Keep the car on the road through a quick, one-button drift challenge.", sourceUrl: "https://poki.com/en/g/drift-boss", accent: "#ff9b5b", mode: "embedded" },
  ...
  { slug: "stickman-hook", title: "Stickman Hook", eyebrow: "POKI ARCADE", genre: "Action", category: "Poki", description: "Swing through colorful levels and land every hook with momentum.", sourceUrl: "https://poki.com/en/g/stickman-hook", accent: "#a98cff", mode: "embedded" },
  { slug: "subway-surfers", title: "Subway Surfers", eyebrow: "POKI ARCADE", genre: "Runner", category: "Poki", description: "Dash through the city, dodge trains, and collect a bright trail of coins.", sourceUrl: "https://poki.com/en/g/subway-surfers", accent: "#42c7e8", mode: "embedded" },
  ...
  { slug: "shell-shockers-web", title: "Shell Shockers", eyebrow: "WEB ARCADE", genre: "Action", category: "Web", description: "Jump into a fast multiplayer egg shooter arena.", sourceUrl: "https://shellshock.io/", accent: "#f4b642", mode: "embedded" },
  ...
  { slug: "celeste-classic", title: "Celeste Classic", eyebrow: "ITCH ARCADE", genre: "Platformer", category: "Itch.io", description: "Climb, jump, and dash through a compact mountain platforming classic.", sourceUrl: "https://maddymakesgames.itch.io/celeste-classic", accent: "#7ec9ff", mode: "embedded" },
