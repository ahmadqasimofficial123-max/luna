...
export const appSettings = mysqlTable("appSettings", { id: int("id").autoincrement().primaryKey(), appName: varchar("appName", { length: 80 }).default("Luna Social").notNull(), tagline: varchar("tagline", { length: 180 }).default("Find your people under the same sky.").notNull(), theme: mysqlEnum("theme", ["dark", "light", "system"]).default("dark").notNull(), accentColor: varchar("accentColor", { length: 7 }).default("#a98cff").notNull(), updatedBy: int("updatedBy") });
